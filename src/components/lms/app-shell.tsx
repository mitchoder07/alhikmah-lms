    ...
    <div className="flex h-full flex-col">
      <div className="p-4 border-b">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 rounded-full albashir-gradient flex items-center justify-center text-white font-bold text-[10px] flex-shrink-0">ABA</div>
      ...
      <nav className="flex-1 p-3 space-y-1 overflow-y-auto albashir-scroll">
        {navItems.map((item) => (
          <button
            key={item.id}
          ...
          <div className="flex items-center gap-1">
            ...
            <DropdownMenu open={notifOpen} onOpenChange={setNotifOpen}>
              ...
              <DropdownMenuContent align="end" className="w-80 p-0">
                ...
                <div className="max-h-80 overflow-y-auto albashir-scroll">
                  {announcements.length === 0 ? (

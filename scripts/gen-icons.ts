...
// SVG source: dark green circle with gold "HUI" monogram
const svg = (size: number) => `<svg width="${size}" height="${size}" viewBox="0 0 ${size} ${size}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="50%" y="50%" font-family="Arial, sans-serif" font-size="${size * 0.28}" font-weight="bold" fill="#D4AF37" text-anchor="middle" dominant-baseline="central">HUI</text>
</svg>`
